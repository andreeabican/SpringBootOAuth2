...
import Andreea.Bican.impl.SAMLUserDetailsServiceImpl;
...
@Configuration
@Import({ FacebookFilter.class, GoogleFilter.class, ProvidersCompositeFilter.class, CSRFHeaderFilter.class})
@EnableOAuth2Client
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                    ...
                    .permitAll()
                .and()
                    .addFilterBefore(metadataGeneratorFilter(), ConcurrentSessionFilter.class)
...
*/
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityBaseURL("http://localhost:8181");
